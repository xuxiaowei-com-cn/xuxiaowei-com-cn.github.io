...
| 镜像                                                           | 说明                                                            |
|--------------------------------------------------------------|---------------------------------------------------------------|
| registry.cn-qingdao.aliyuncs.com/xuxiaoweicomcn/httpd:2.4.62 | 2.4.62 代表版本号，支持：s390x、ppc64le、mips64le、arm64、arm、amd64、386 平台 |
| registry.cn-qingdao.aliyuncs.com/xuxiaoweicomcn/httpd:2.4.57 |                                                               |
...
sudo docker run \
  ...
  -p 80:80 \
  -p 443:443 \
  -d registry.cn-qingdao.aliyuncs.com/xuxiaoweicomcn/httpd:2.4.62
```
...
sudo docker run \
  ...
  -p 80:80 \
  -p 443:443 \
  -v /httpd/htdocs:/usr/local/apache2/htdocs \
  -d registry.cn-qingdao.aliyuncs.com/xuxiaoweicomcn/httpd:2.4.62
```

```shell [默认 /usr/local/apache2/conf/httpd.conf]
#
